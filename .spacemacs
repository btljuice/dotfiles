...
(custom-set-variables
 ...
 '(ledger-reports
   (quote
    (("bal alexioyflo" "ledger -f /home/btljuice/gdrive/doc/budget/ledger/alexis/alexis.ledger bal not loyer and not electricite and not netflix and not internet and alexioyflo")
     ("bal assets liabilities" "%(binary) -f %(ledger-file) bal assets liabilities acompte")
